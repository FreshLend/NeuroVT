...
class STTModule(BaseModule):
    ...
    def register_routes(self):
        ...
        @self.app.route('/api/stt/set_virtual_device', methods=['POST'])
        ...
        @self.app.route('/api/stt/set_virtual_hotkey', methods=['POST'])
        ...
        @self.app.route('/api/stt/toggle', methods=['POST'])
        def stt_toggle():
            if self.is_listening:
                self.stop_listening()
        ...
        @self.app.route('/api/stt/toggle_virtual', methods=['POST'])
        ...
        @self.app.route('/api/stt/restart_virtual', methods=['POST'])
